...
export default function ProductLayout() {
  ...
  const sortedProducts = useMemo(() => {
    switch (activeSort) {
      ...
      case "20":
        return [...productbasictshirt].sort((a, b) => b.salesCount - a.salesCount);
      case "25":
        return [...productbasictshirt].sort((a, b) => b.ratingCount - a.ratingCount);
      default:
              ...
              return (
                ...
                >
                  <div className="bg-white rounded-lg shadow-md overflow-hidden cursor-pointer hover:shadow-xl transition w-full h-60 relative">
                    ...
                    {productbasictshirt.oldPrice && productbasictshirt.oldPrice > productbasictshirt.price && (
